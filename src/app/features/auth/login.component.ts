  ...
  template: `
    <div class="h-screen bg-gray-50 dark:bg-gray-950 flex flex-col justify-center pt-12 pb-40 px-4 sm:px-6 lg:px-8 relative overflow-hidden transition-colors duration-300">
      ...
      <div class="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
            ...
            <div class="bg-white dark:bg-gray-800 py-8 px-4 shadow-xl shadow-gray-200/50 dark:shadow-gray-900/50 rounded-2xl sm:px-10 border border-gray-100 dark:border-gray-700 backdrop-blur-sm">
