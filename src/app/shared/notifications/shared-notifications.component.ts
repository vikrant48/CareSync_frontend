...
import { NgFor, NgIf } from '@angular/common'; // These imports are still needed for backward compatibility
    ...
    <div class="notifications-container p-4">
      ...
      <div class="notification-list">
        @for (notification of notifications; track notification.id) {
          <div class="notification-item p-3 mb-2 rounded border-l-4"
               [class]="{
