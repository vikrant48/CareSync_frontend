      ...
      <div class="relative w-[min(calc(100vw-1.5rem),460px)] max-w-lg bg-white dark:bg-gray-900 rounded-2xl shadow-2xl ring-1 ring-black/5 dark:ring-white/10 overflow-hidden flex flex-col max-h-[85vh] animate-in zoom-in-95 duration-200">
        ...
        <div class="flex-1 overflow-y-auto p-3.5 sm:p-6 space-y-3 sm:space-y-5 scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-700 scrollbar-track-transparent">
          ...
          <div *ngIf="!selectedMethod()">
             <div class="text-xs font-semibold text-gray-500 dark:text-gray-400 mb-2 uppercase tracking-wider">Select Payment Method</div>
             <div class="grid gap-2.5 sm:gap-3">
               ...
               <button 
                 ...
                 class="group relative flex items-center p-3 sm:p-4 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 hover:bg-white dark:hover:bg-gray-800 hover:border-purple-500 dark:hover:border-purple-500/50 transition-all duration-200 text-left shadow-sm hover:shadow-md"
               >
                 <div class="h-8 w-8 sm:h-10 sm:w-10 rounded-full bg-purple-100 dark:bg-purple-500/10 flex items-center justify-center text-purple-600 dark:text-purple-400 group-hover:scale-110 transition-transform shrink-0">
                   <i class="fa-regular fa-credit-card text-sm sm:text-lg"></i>
                 </div>
                 <div class="ml-3 sm:ml-4 flex-1 min-w-0">
                   <h3 class="font-semibold text-xs sm:text-sm text-gray-900 dark:text-gray-200 group-hover:text-purple-600 dark:group-hover:text-white truncate">Card Payment</h3>
                   <p class="text-[11px] sm:text-xs text-gray-500 dark:text-gray-400 truncate">Credit & Debit Cards</p>
                 </div>
                 <i class="fa-solid fa-chevron-right text-xs text-gray-400 dark:text-gray-600 group-hover:text-purple-500 dark:group-hover:text-purple-400 shrink-0"></i>
               </button>
 
               <!-- QR Option -->
               <button 
                 (click)="selectPaymentMethod('qr')"
                 class="group relative flex items-center p-3 sm:p-4 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 hover:bg-white dark:hover:bg-gray-800 hover:border-emerald-500 dark:hover:border-emerald-500/50 transition-all duration-200 text-left shadow-sm hover:shadow-md"
               >
                 <div class="h-8 w-8 sm:h-10 sm:w-10 rounded-full bg-emerald-100 dark:bg-emerald-500/10 flex items-center justify-center text-emerald-600 dark:text-emerald-400 group-hover:scale-110 transition-transform shrink-0">
                   <i class="fa-solid fa-qrcode text-sm sm:text-lg"></i>
                 </div>
                 <div class="ml-3 sm:ml-4 flex-1 min-w-0">
                   <h3 class="font-semibold text-xs sm:text-sm text-gray-900 dark:text-gray-200 group-hover:text-emerald-600 dark:group-hover:text-white truncate">Scan QR</h3>
                   <p class="text-[11px] sm:text-xs text-gray-500 dark:text-gray-400 truncate">Scan to pay instantly</p>
                 </div>
